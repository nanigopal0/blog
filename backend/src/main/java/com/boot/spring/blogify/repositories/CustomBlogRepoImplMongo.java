...
@Slf4j
@Repository
public class CustomBlogRepoImplMongo implements CustomBlogRepo {
    ...
    @Override
    public Optional<BlogDataDTO> findBlogById(ObjectId blogId, ObjectId userId, Pageable pageable) {
        Aggregation aggregation = Aggregation.newAggregation(
        ...
        return Optional.ofNullable(mongoTemplate.aggregate(aggregation, "blogs", BlogDataDTO.class).getUniqueMappedResult());
    }
