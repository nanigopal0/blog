...
public class AdminServiceImpl implements AdminService {
    ...
    public AdminServiceImpl(PasswordEncoder passwordEncoder, AdminRepo adminRepo, JwtService jwtService, UserServiceImpl userServiceImpl, AuthenticationManager authenticationManager, HttpServletResponse response) {
    ...
    public void login(Admin admin) {
        ...
        userServiceImpl.addTokenToCookie(response, token);
    }
