...
import { MenuIcon, CloseIcon, BoldIcon, ItalicIcon, UndoIcon, RedoIcon } from "./toolbar/ToolbarIcons.js";
import { ToolbarButton, ToolbarDivider } from "./toolbar/ToolbarPrimitives.js";
import {
  UndoRedoSection,
  HeadingsSection,
  ...
  HighlightSection,
  ScriptSection,
} from "./toolbar/TextFormattingSections.js";
import {
  ListsSection,
  BlocksSection,
  AlignmentSection,
  InsertSection,
} from "./toolbar/BlockSections.js";
import { MobileMenu } from "./toolbar/MobileMenu.js";
import type { ToolbarSectionProps } from "./types/ToolbarSectionProps.js";


export default function EditorToolbar({ editor }:ToolbarSectionProps) {
