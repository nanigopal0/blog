...
import { CloseIcon, ImageIcon, UploadIcon, UrlIcon } from ".";
...
export default function TiptapImage({ editor, onComplete }) {
  ...
  const handleFileUpload = (event) => {
    ...
    uploadImage(file)
      ...
      .catch((error) => setError("Failed to upload image ", error))
      .finally(() => {
        setIsLoading(false);
      });
