...
import { ToolbarButton, ToolbarSection } from "./ToolbarPrimitives.js";
import {
  BoldIcon,
  ItalicIcon,
  UnderlineIcon,
...
import { HIGHLIGHT_COLORS } from "./TextFormattingSections.js";
import { ImageInsert, LinkInsert } from "./BlockSections.js";
...
export const MobileMenu = ({ editor, onClose }: MobileMenuProps) => (
  <div
    className="
