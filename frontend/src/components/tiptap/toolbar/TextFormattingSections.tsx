...
// Undo/Redo section
export const UndoRedoSection = ({ editor }:ToolbarSectionProps) => {
...
// Headings dropdown
export const HeadingsSection = ({ editor }:ToolbarSectionProps) => {
  const state = useEditorState({
    editor,
    selector: ({ editor: e }) => ({
...
export const TextFormattingSection = ({ editor }:ToolbarSectionProps) => {
  const state = useEditorState({
    editor,
    selector: ({ editor: e }) => ({
...
export const HighlightSection = ({ editor }:ToolbarSectionProps) => {
  const state = useEditorState({
    editor,
    selector: ({ editor: e }) => ({
    ...
    >
      {HIGHLIGHT_COLORS.map(({ color, name }, index) => (
        <DropdownItem
          ...
          isActive={state.activeColors[index]?.isActive ?? false}
        >
...
export const ScriptSection = ({ editor }:ToolbarSectionProps) => {
  const state = useEditorState({
    editor,
    selector: ({ editor: e }) => ({
